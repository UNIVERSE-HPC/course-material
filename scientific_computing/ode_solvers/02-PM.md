...
_When Zombies Attack!: Mathematical Modelling of an Outbreak of Zombie Infection_
by Munz, Hudea, Imad, and Smith? (2009), and includes modelling code in `Matlab`.
